# Generated by Django 2.2.28 on 2022-06-23 08:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('blog', '0002_auto_20220623_1659'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='category',
            options={'ordering': ['tn_order'], 'verbose_name': 'Category', 'verbose_name_plural': 'Categories'},
        ),
        migrations.AddField(
            model_name='category',
        ...
        migrations.AddField(
            model_name='category',
            name='tn_parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tn_children', to='blog.Category', verbose_name='Parent'),
        ),
        migrations.AddField(
            model_name='category',
            name='tn_priority',
